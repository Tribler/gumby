...
$WORKSPACE_DIR/$PROCESS_GUARD_CMD -c "$REPOSITORY_DIR/swift -t $SEEDER_IP:$SEEDER_PORT -o $LOGS_DIR/dst/$LEECHER_ID -h $HASH -p -D $LOGS_DIR/dst/$LEECHER_ID/leecher_$LEECHER_ID " -t $EXPERIMENT_TIME -o $LOGS_DIR/dst/$LEECHER_ID &
