...
class MultiChainClient(DispersyExperimentScriptClient):
    ...
    def online(self, dont_empty=False):
        ...
        msg("%s: MID: %s" % (self.my_id, base64.encodestring(self._community.my_member.mid)))
...
class MultiChainGumbyCommunity(MultiChainCommunity):
    ...
    """
#    def __init__(self, *args, **kwargs):
#        super(MultiChainGumbyCommunity, self).__init__(*args, **kwargs)

#    @property
#    def dispersy_enable_candidate_walker(self):
#	#msg("Not enabling walker")
#        return False;
...
if __name__ == '__main__':
    MultiChainClient.scenario_file = environ.get('SCENARIO_FILE', 'multichain_crawl_simple.scenario')
