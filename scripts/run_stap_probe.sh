...
$STAPPATH/stap "$SCRIPTDIR"/stp/log_io_writes.stp -I $SCRIPTDIR/stp/tapsets/ -DMAXMAPENTRIES=10000 -DSTP_NO_OVERLOAD -DMAXSTRINGLEN=4096 -DTRYLOCKDELAY=300 -DMAXSKIPPED=10000 -DMAXACTION=1000 -c "env 'LD_LIBRARY_PATH=$LD_LIBRARY_PATH' $TESTCASE"
